...
public class BrAPIGenomeMapSingleResponse implements BrAPIResponse<BrAPIGenomeMap>  {
  ...
  @JsonProperty("result")
  private BrAPIGenomeMap result = null;

  public BrAPIGenomeMapSingleResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPIGenomeMapSingleResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPIGenomeMapSingleResponse result(BrAPIGenomeMap result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPIGenomeMap getResult() {
    return result;
  }

  public void setResult(BrAPIGenomeMap result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPIGenomeMapSingleResponse genomeMapSingleResponse = (BrAPIGenomeMapSingleResponse) o;
