 ...
 */
public class BrAPIImageDeleteResponseResult {
	@JsonProperty("imageDbIds")
    private List<String> imageDbIds = new ArrayList<String>();

    public BrAPIImageDeleteResponseResult imageDbIds(List<String> imageDbIds) {
        this.imageDbIds = imageDbIds;
        return this;
    }

    public BrAPIImageDeleteResponseResult addImageDbIdsItem(String imageDbIdsItem) {
        this.imageDbIds.add(imageDbIdsItem);
        return this;
    }

    /**
     * The unique ids of the Image records which have been successfully deleted
     *
     * @return imageDbIds
     **/
    ...
    public boolean equals(Object o) {
        ...
        BrAPIImageDeleteResponseResult imageDeleteResponseResult = (BrAPIImageDeleteResponseResult) o;
