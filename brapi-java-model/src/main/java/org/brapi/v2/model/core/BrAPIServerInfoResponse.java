...
public class BrAPIServerInfoResponse implements BrAPIResponse<BrAPIServerInfo>  {
  ...
  @JsonProperty("result")
  private BrAPIServerInfo result = null;

  public BrAPIServerInfoResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPIServerInfoResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPIServerInfoResponse result(BrAPIServerInfo result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPIServerInfo getResult() {
    return result;
  }

  public void setResult(BrAPIServerInfo result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPIServerInfoResponse callsResponse = (BrAPIServerInfoResponse) o;
