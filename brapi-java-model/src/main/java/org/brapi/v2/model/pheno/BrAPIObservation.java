...
public class BrAPIObservation  {
  ...
  public BrAPIObservation additionalInfo(Map<String, String> additionalInfo) {
    this.additionalInfo = additionalInfo;
    return this;
  }

  public BrAPIObservation putAdditionalInfoItem(String key, String additionalInfoItem) {
