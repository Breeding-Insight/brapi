...
public class BrAPIScaleSingleResponse implements BrAPIResponse<BrAPIScale> {
	...
	@JsonProperty("result")
	private BrAPIScale result = null;

	public BrAPIScaleSingleResponse _atContext(BrAPIContext _atContext) {
	...
	public BrAPIScaleSingleResponse metadata(BrAPIMetadata metadata) {
	...
	public BrAPIScaleSingleResponse result(BrAPIScale result) {
		this.result = result;
		return this;
	}
	...
	@Valid
	public BrAPIScale getResult() {
		return result;
	}

	public void setResult(BrAPIScale result) {
		this.result = result;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		BrAPIScaleSingleResponse scaleSingleResponse = (BrAPIScaleSingleResponse) o;
