...
public class BrAPIMethodBaseClass {
	...
	public BrAPIMethodBaseClass additionalInfo(Map<String, String> additionalInfo) {
		this.additionalInfo = additionalInfo;
		return this;
	}

	public BrAPIMethodBaseClass putAdditionalInfoItem(String key, String additionalInfoItem) {
	...
	public BrAPIMethodBaseClass bibliographicalReference(String bibliographicalReference) {
	...
	public BrAPIMethodBaseClass description(String description) {
	...
	public BrAPIMethodBaseClass externalReferences(BrAPIExternalReferenceList externalReferences) {
	...
	public BrAPIMethodBaseClass formula(String formula) {
	...
	public BrAPIMethodBaseClass methodClass(String methodClass) {
	...
	public BrAPIMethodBaseClass methodName(String methodName) {
	...
	public BrAPIMethodBaseClass ontologyReference(BrAPIOntologyReference ontologyReference) {
	...
	public boolean equals(java.lang.Object o) {
		...
		BrAPIMethodBaseClass methodBaseClass = (BrAPIMethodBaseClass) o;
