...
public class BrAPIGermplasmNewRequest {
	...
	@JsonProperty("donors")
	@Valid
	private List<BrAPIGermplasmNewRequestDonors> donors = null;
	...
	@Valid
	private List<BrAPIGermplasmNewRequestSynonyms> synonyms = null;

	@JsonProperty("taxonIds")
	@Valid
	private List<BrAPITaxonID> taxonIds = null;

	public BrAPIGermplasmNewRequest accessionNumber(String accessionNumber) {
	...
	public BrAPIGermplasmNewRequest acquisitionDate(LocalDate acquisitionDate) {
	...
	public BrAPIGermplasmNewRequest additionalInfo(Map<String, String> additionalInfo) {
		this.additionalInfo = additionalInfo;
		return this;
	}

	public BrAPIGermplasmNewRequest putAdditionalInfoItem(String key, String additionalInfoItem) {
	...
	public BrAPIGermplasmNewRequest biologicalStatusOfAccessionCode(
	...
	public BrAPIGermplasmNewRequest biologicalStatusOfAccessionDescription(String biologicalStatusOfAccessionDescription) {
	...
	public BrAPIGermplasmNewRequest breedingMethodDbId(String breedingMethodDbId) {
	...
	public BrAPIGermplasmNewRequest collection(String collection) {
	...
	public BrAPIGermplasmNewRequest commonCropName(String commonCropName) {
	...
	public BrAPIGermplasmNewRequest countryOfOriginCode(String countryOfOriginCode) {
	...
	public BrAPIGermplasmNewRequest defaultDisplayName(String defaultDisplayName) {
	...
	public BrAPIGermplasmNewRequest documentationURL(String documentationURL) {
	...
	public BrAPIGermplasmNewRequest donors(List<BrAPIGermplasmNewRequestDonors> donors) {
		this.donors = donors;
		return this;
	}

	public BrAPIGermplasmNewRequest addDonorsItem(BrAPIGermplasmNewRequestDonors donorsItem) {
		if (this.donors == null) {
			this.donors = new ArrayList<BrAPIGermplasmNewRequestDonors>();
		}
	...
	@Valid
	public List<BrAPIGermplasmNewRequestDonors> getDonors() {
		return donors;
	}

	public void setDonors(List<BrAPIGermplasmNewRequestDonors> donors) {
		this.donors = donors;
	}

	public BrAPIGermplasmNewRequest externalReferences(BrAPIExternalReferenceList externalReferences) {
	...
	public BrAPIGermplasmNewRequest genus(String genus) {
		this.genus = genus;
		return this;
	}
	...
	public BrAPIGermplasmNewRequest germplasmName(String germplasmName) {
	...
	public BrAPIGermplasmNewRequest germplasmOrigin(List<BrAPIGermplasmOrigin> germplasmOrigin) {
		this.germplasmOrigin = germplasmOrigin;
		return this;
	}

	public BrAPIGermplasmNewRequest addGermplasmOriginItem(BrAPIGermplasmOrigin germplasmOriginItem) {
	...
	public BrAPIGermplasmNewRequest germplasmPUI(String germplasmPUI) {
	...
	public BrAPIGermplasmNewRequest germplasmPreprocessing(String germplasmPreprocessing) {
	...
	public BrAPIGermplasmNewRequest instituteCode(String instituteCode) {
	...
	public BrAPIGermplasmNewRequest instituteName(String instituteName) {
	...
	public BrAPIGermplasmNewRequest pedigree(String pedigree) {
	...
	public BrAPIGermplasmNewRequest seedSource(String seedSource) {
	...
	public BrAPIGermplasmNewRequest seedSourceDescription(String seedSourceDescription) {
	...
	public BrAPIGermplasmNewRequest species(String species) {
	...
	public BrAPIGermplasmNewRequest speciesAuthority(String speciesAuthority) {
	...
	public BrAPIGermplasmNewRequest storageTypes(List<BrAPIGermplasmStorageTypes> storageTypes) {
		this.storageTypes = storageTypes;
		return this;
	}

	public BrAPIGermplasmNewRequest addStorageTypesItem(BrAPIGermplasmStorageTypes storageTypesItem) {
	...
	public BrAPIGermplasmNewRequest subtaxa(String subtaxa) {
	...
	public BrAPIGermplasmNewRequest subtaxaAuthority(String subtaxaAuthority) {
	...
	public BrAPIGermplasmNewRequest synonyms(List<BrAPIGermplasmNewRequestSynonyms> synonyms) {
		this.synonyms = synonyms;
		return this;
	}

	public BrAPIGermplasmNewRequest addSynonymsItem(BrAPIGermplasmNewRequestSynonyms synonymsItem) {
		if (this.synonyms == null) {
			this.synonyms = new ArrayList<BrAPIGermplasmNewRequestSynonyms>();
		}
	...
	@Valid
	public List<BrAPIGermplasmNewRequestSynonyms> getSynonyms() {
		return synonyms;
	}

	public void setSynonyms(List<BrAPIGermplasmNewRequestSynonyms> synonyms) {
		this.synonyms = synonyms;
	}

	public BrAPIGermplasmNewRequest taxonIds(List<BrAPITaxonID> taxonIds) {
		this.taxonIds = taxonIds;
		return this;
	}

	public BrAPIGermplasmNewRequest addTaxonIdsItem(BrAPITaxonID taxonIdsItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		BrAPIGermplasmNewRequest germplasmNewRequest = (BrAPIGermplasmNewRequest) o;
