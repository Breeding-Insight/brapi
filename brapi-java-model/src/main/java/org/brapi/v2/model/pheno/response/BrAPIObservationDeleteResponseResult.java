...
public class BrAPIObservationDeleteResponseResult {
	@JsonProperty("observationDbIds")
    private List<String> observationDbIds = new ArrayList<String>();

    public BrAPIObservationDeleteResponseResult observationDbIds(List<String> observationDbIds) {
        this.observationDbIds = observationDbIds;
        return this;
    }

    public BrAPIObservationDeleteResponseResult addObservationDbIdsItem(String observationDbIdsItem) {
        this.observationDbIds.add(observationDbIdsItem);
        return this;
    }

    /**
     * The unique ids of the Observation records which have been successfully deleted
     *
    ...
    public boolean equals(Object o) {
        ...
        BrAPIObservationDeleteResponseResult observationDeleteResponseResult = (BrAPIObservationDeleteResponseResult) o;
