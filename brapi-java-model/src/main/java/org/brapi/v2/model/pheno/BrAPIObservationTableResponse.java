...
public class BrAPIObservationTableResponse implements BrAPIResponse<BrAPIObservationTable>  {
  ...
  @JsonProperty("result")
  private BrAPIObservationTable result = null;

  public BrAPIObservationTableResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPIObservationTableResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPIObservationTableResponse result(BrAPIObservationTable result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPIObservationTable getResult() {
    return result;
  }

  public void setResult(BrAPIObservationTable result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPIObservationTableResponse observationTableResponse = (BrAPIObservationTableResponse) o;
