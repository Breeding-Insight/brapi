...
public class BrAPIImageNewRequest   {
  ...
  public BrAPIImageNewRequest additionalInfo(Map<String, String> additionalInfo) {
    this.additionalInfo = additionalInfo;
    return this;
  }

  public BrAPIImageNewRequest putAdditionalInfoItem(String key, String additionalInfoItem) {
  ...
  **/
  ...
  public BrAPIImageNewRequest copyright(String copyright) {
  ...
  **/
  ...
  public BrAPIImageNewRequest description(String description) {
  ...
  **/
  ...
  public BrAPIImageNewRequest descriptiveOntologyTerms(List<String> descriptiveOntologyTerms) {
    this.descriptiveOntologyTerms = descriptiveOntologyTerms;
    return this;
  }

  public BrAPIImageNewRequest addDescriptiveOntologyTermsItem(String descriptiveOntologyTermsItem) {
  ...
  **/
  ...
  public BrAPIImageNewRequest externalReferences(BrAPIExternalReferenceList externalReferences) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageFileName(String imageFileName) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageFileSize(Integer imageFileSize) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageHeight(Integer imageHeight) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageLocation(BrApiGeoJSON imageLocation) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageName(String imageName) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageTimeStamp(OffsetDateTime imageTimeStamp) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageURL(String imageURL) {
  ...
  **/
  ...
  public BrAPIImageNewRequest imageWidth(Integer imageWidth) {
  ...
  **/
  ...
  public BrAPIImageNewRequest mimeType(String mimeType) {
  ...
  **/
  ...
  public BrAPIImageNewRequest observationDbIds(List<String> observationDbIds) {
    this.observationDbIds = observationDbIds;
    return this;
  }

  public BrAPIImageNewRequest addObservationDbIdsItem(String observationDbIdsItem) {
  ...
  **/
  ...
  public BrAPIImageNewRequest observationUnitDbId(String observationUnitDbId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPIImageNewRequest imageNewRequest = (BrAPIImageNewRequest) o;
