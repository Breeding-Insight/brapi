...
public class BrAPIImageSingleResponse implements BrAPIResponse<BrAPIImage>  {
  ...
  @JsonProperty("result")
  private BrAPIImage result = null;

  public BrAPIImageSingleResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPIImageSingleResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPIImageSingleResponse result(BrAPIImage result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPIImage getResult() {
    return result;
  }

  public void setResult(BrAPIImage result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPIImageSingleResponse imageSingleResponse = (BrAPIImageSingleResponse) o;
