...
public class BrAPISampleNewRequest   {
  ...
  public BrAPISampleNewRequest additionalInfo(Map<String, String> additionalInfo) {
    this.additionalInfo = additionalInfo;
    return this;
  }

  public BrAPISampleNewRequest putAdditionalInfoItem(String key, String additionalInfoItem) {
  ...
  **/
  ...
  public BrAPISampleNewRequest externalReferences(BrAPIExternalReferenceList externalReferences) {
