...
public class BrAPILocationSingleResponse implements BrAPIResponse<BrAPILocation>  {
  ...
  @JsonProperty("result")
  private BrAPILocation result = null;

  public BrAPILocationSingleResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPILocationSingleResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPILocationSingleResponse result(BrAPILocation result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPILocation getResult() {
    return result;
  }

  public void setResult(BrAPILocation result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPILocationSingleResponse locationSingleResponse = (BrAPILocationSingleResponse) o;
