...
public class BrAPISampleSingleResponse implements BrAPIResponse<BrAPISample>  {
  ...
  @JsonProperty("result")
  private BrAPISample result = null;

  public BrAPISampleSingleResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPISampleSingleResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPISampleSingleResponse result(BrAPISample result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPISample getResult() {
    return result;
  }

  public void setResult(BrAPISample result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPISampleSingleResponse sampleSingleResponse = (BrAPISampleSingleResponse) o;
