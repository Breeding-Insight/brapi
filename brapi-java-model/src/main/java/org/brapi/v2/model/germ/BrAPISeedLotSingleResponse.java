...
public class BrAPISeedLotSingleResponse implements BrAPIResponse<BrAPISeedLot>  {
  ...
  @JsonProperty("result")
  private BrAPISeedLot result = null;

  public BrAPISeedLotSingleResponse _atContext(BrAPIContext _atContext) {
  ...
  public BrAPISeedLotSingleResponse metadata(BrAPIMetadata metadata) {
  ...
  **/
  ...
  public BrAPISeedLotSingleResponse result(BrAPISeedLot result) {
    this.result = result;
    return this;
  }
  ...
  **/
    ...
    @Valid
    public BrAPISeedLot getResult() {
    return result;
  }

  public void setResult(BrAPISeedLot result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BrAPISeedLotSingleResponse seedLotSingleResponse = (BrAPISeedLotSingleResponse) o;
