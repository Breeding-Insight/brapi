...
public enum BrAPIBiologicalStatusOfAccessionCode {
    ...
    @JsonCreator
    public static BrAPIBiologicalStatusOfAccessionCode fromValue(String text) {
      for (BrAPIBiologicalStatusOfAccessionCode b : BrAPIBiologicalStatusOfAccessionCode.values()) {
