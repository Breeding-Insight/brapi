 ...
 */
@Schema(description = "An analysis contains an interpretation of one or several experiments. (e.g. SNVs, copy number variations, methylation status) together with information about the methodology used.")
...
public class Analysis {
     ...
     * @return analysisDbId
     **/
    @Schema(example = "6191a6bd", description = "Unique identifier for this analysis description")
     ...
     * @return analysisName
     **/
    @Schema(example = "Standard QC", description = "A human readable name for this analysis")
     ...
     * @return created
     **/
    @Schema(description = "The time at which this record was created, in ISO 8601 format.")
     ...
     * @return description
     **/
    @Schema(example = "This is a formal description of a QC methodology. Blah blah blah ...", description = "A human readable description of the analysis")
     ...
     * @return software
     **/
    @Schema(example = "[\"https://github.com/genotyping/QC\"]", description = "The software run to generate this analysis.")
     ...
     * @return type
     **/
    @Schema(example = "QC", description = "The type of analysis.")
     ...
     * @return updated
     **/
    @Schema(description = "The time at which this record was last updated, in ISO 8601 format.")
