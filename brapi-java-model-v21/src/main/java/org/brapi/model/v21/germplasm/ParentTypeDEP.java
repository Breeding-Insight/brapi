 ...
 */
@JsonAdapter(ParentTypeDEP.Adapter.class)
public enum ParentTypeDEP {
    MALE("MALE"),
    FEMALE("FEMALE"),
    SELF("SELF"),
    ...
    public static ParentTypeDEP fromValue(String input) {
        for (ParentTypeDEP b : ParentTypeDEP.values()) {
    ...
    public static class Adapter extends TypeAdapter<ParentTypeDEP> {
        @Override
        public void write(final JsonWriter jsonWriter, final ParentTypeDEP enumeration) throws IOException {
            jsonWriter.value(String.valueOf(enumeration.getValue()));
        }

        @Override
        public ParentTypeDEP read(final JsonReader jsonReader) throws IOException {
            Object value = jsonReader.nextString();
            return ParentTypeDEP.fromValue((String) (value));
        }
    }
}
