 ...
 */
@Schema(description = "a custom attributes associated with a cross")
...
public class CrossCrossAttributes {
    @SerializedName("crossAttributeName")
    private String crossAttributeName = null;

    @SerializedName("crossAttributeValue")
    private String crossAttributeValue = null;

    public CrossCrossAttributes crossAttributeName(String crossAttributeName) {
     ...
     **/
    @Schema(example = "Humidity Percentage", description = "the human readable name of a cross attribute")
    ...
    public CrossCrossAttributes crossAttributeValue(String crossAttributeValue) {
     ...
     **/
    @Schema(example = "45", description = "the value of a cross attribute")
    ...
    public boolean equals(Object o) {
        ...
        CrossCrossAttributes crossCrossAttributes = (CrossCrossAttributes) o;
