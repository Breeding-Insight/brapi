...
public class VendorPlateSubmissionPlates {
     ...
     **/
    @Schema(example = "bfb33593", description = "(Optional) The value of the bar code attached to this plate")
     ...
     **/
    @Schema(example = "dae8f49d", description = "The ID which uniquely identifies this plate to the client making the request")
