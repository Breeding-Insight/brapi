 ...
 */
@Schema(description = "A GeoJSON Polygon which describes an area to search for other GeoJSON objects. All contained Points and intersecting Polygons should be returned as search results.   All coordinates are decimal values on the WGS84 geographic coordinate reference system.")
...
public class GeoJSONSearchArea {
    @SerializedName("geometry")
    private OneOfGeoJSONSearchAreaGeometry geometry = null;

    @SerializedName("type")
    private String type = "Feature";

    public GeoJSONSearchArea geometry(OneOfGeoJSONSearchAreaGeometry geometry) {
    ...
    public OneOfGeoJSONSearchAreaGeometry getGeometry() {
        return geometry;
    }

    public void setGeometry(OneOfGeoJSONSearchAreaGeometry geometry) {
        this.geometry = geometry;
    }

    public GeoJSONSearchArea type(String type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        GeoJSONSearchArea geoJSONSearchArea = (GeoJSONSearchArea) o;
        return Objects.equals(this.geometry, geoJSONSearchArea.geometry) &&
                Objects.equals(this.type, geoJSONSearchArea.type);
    }
