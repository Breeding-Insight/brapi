...
public class BreedingMethod {
     ...
     * @return abbreviation
     **/
    @Schema(example = "MB", description = "A shortened version of the human readable name for a Breeding Method")
     ...
     **/
    @Schema(example = "ffcce7ef", required = true, description = "the unique identifier for this breeding method")
     ...
     * @return description
     **/
    @Schema(example = "Backcross to recover a specific gene.", description = "human readable description of the breeding method")
