 ...
 */
@Schema(description = "The exact level and level code of an observation unit.   For more information on Observation Levels, please review the <a target=\"_blank\" href=\"https://wiki.brapi.org/index.php/Observation_Levels\">Observation Levels documentation</a>.   MIAPPE V1.1 DM-71 Observation unit type \"Type of observation unit in textual form, usually one of the following: study, block, sub-block, plot, sub-plot, pot, plant. Use of other observation unit types is possible but not recommended.  The observation unit type can not be used to indicate sub-plant levels. However, observations can still be made on the sub-plant level, as long as the details are indicated in the associated observed variable (see observed variables).  Alternatively, it is possible to use samples for more detailed tracing of sub-plant units, attaching the observations to them instead.\" ")
...
public class ObservationUnitLevel2 {
    ...
    public ObservationUnitLevel2 levelCode(String levelCode) {
    ...
    public ObservationUnitLevel2 levelName(String levelName) {
    ...
    public ObservationUnitLevel2 levelOrder(Integer levelOrder) {
    ...
    public boolean equals(Object o) {
        ...
        ObservationUnitLevel2 observationUnitLevel2 = (ObservationUnitLevel2) o;
        return Objects.equals(this.levelCode, observationUnitLevel2.levelCode) &&
                Objects.equals(this.levelName, observationUnitLevel2.levelName) &&
                Objects.equals(this.levelOrder, observationUnitLevel2.levelOrder);
    }
    ...
    public String toString() {
        ...
        sb.append("class ObservationUnitLevel2 {\n");
