...
public class GermplasmTaxonIds {
    ...
    public GermplasmTaxonIds sourceName(String sourceName) {
     ...
     * @return sourceName
     **/
    @Schema(example = "NCBI", required = true, description = "The human readable name of the taxonomy provider")
    ...
    public GermplasmTaxonIds taxonId(String taxonId) {
     ...
     * @return taxonId
     **/
    @Schema(example = "2026747", required = true, description = "The identifier (name, ID, URI) of a particular taxonomy within the source provider")
    ...
    public boolean equals(Object o) {
        ...
        GermplasmTaxonIds germplasmTaxonIds = (GermplasmTaxonIds) o;
        return Objects.equals(this.sourceName, germplasmTaxonIds.sourceName) &&
                Objects.equals(this.taxonId, germplasmTaxonIds.taxonId);
    }
    ...
    public String toString() {
        ...
        sb.append("class GermplasmTaxonIds {\n");
