...
public class MetadataBase {
    ...
    public MetadataBase datafiles(List<MetadataDatafiles> datafiles) {
        this.datafiles = datafiles;
        return this;
    }

    public MetadataBase addDatafilesItem(MetadataDatafiles datafilesItem) {
    ...
    public MetadataBase status(List<MetadataStatus> status) {
        this.status = status;
        return this;
    }

    public MetadataBase addStatusItem(MetadataStatus statusItem) {
        if (this.status == null) {
