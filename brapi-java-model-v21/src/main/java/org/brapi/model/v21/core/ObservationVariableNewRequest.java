...
public class ObservationVariableNewRequest {
    ...
    @SerializedName("observationVariablePUI")
    ...
    public ObservationVariableNewRequest additionalInfo(Map<String, String> additionalInfo) {
        this.additionalInfo = additionalInfo;
        return this;
    }

    public ObservationVariableNewRequest putAdditionalInfoItem(String key, String additionalInfoItem) {
    ...
    public ObservationVariableNewRequest commonCropName(String commonCropName) {
    ...
    public ObservationVariableNewRequest contextOfUse(List<String> contextOfUse) {
        this.contextOfUse = contextOfUse;
        return this;
    }

    public ObservationVariableNewRequest addContextOfUseItem(String contextOfUseItem) {
    ...
    public ObservationVariableNewRequest defaultValue(String defaultValue) {
    ...
    public ObservationVariableNewRequest documentationURL(String documentationURL) {
    ...
    public ObservationVariableNewRequest externalReferences(List<ExternalReferencesInner> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public ObservationVariableNewRequest addExternalReferencesItem(ExternalReferencesInner externalReferencesItem) {
    ...
    public ObservationVariableNewRequest growthStage(String growthStage) {
    ...
    public ObservationVariableNewRequest institution(String institution) {
    ...
    public ObservationVariableNewRequest method(ObservationVariableMethod method) {
        this.method = method;
        return this;
    }
     ...
     **/
    @Schema(example = "Variable Name", description = "Human readable name of an Observation Variable")
    ...
    public ObservationVariableNewRequest observationVariablePUI(String observationVariablePUI) {
     ...
     **/
    @Schema(example = "http://my-traits.com/trait/CO_123:0009012", description = "The Permanent Unique Identifier of a Observation Variable, usually in the form of a URI")
    ...
    public ObservationVariableNewRequest ontologyReference(MethodOntologyReference ontologyReference) {
    ...
    public ObservationVariableNewRequest scale(ObservationVariableScale scale) {
        this.scale = scale;
        return this;
    }
    ...
    public ObservationVariableNewRequest scientist(String scientist) {
    ...
    public ObservationVariableNewRequest status(String status) {
        this.status = status;
        return this;
    }
    ...
    public ObservationVariableNewRequest submissionTimestamp(OffsetDateTime submissionTimestamp) {
    ...
    public ObservationVariableNewRequest synonyms(List<String> synonyms) {
        this.synonyms = synonyms;
        return this;
    }

    public ObservationVariableNewRequest addSynonymsItem(String synonymsItem) {
    ...
    public ObservationVariableNewRequest trait(ObservationVariableTrait trait) {
        this.trait = trait;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.additionalInfo, observationVariableNewRequest.additionalInfo) &&
                Objects.equals(this.commonCropName, observationVariableNewRequest.commonCropName) &&
                Objects.equals(this.contextOfUse, observationVariableNewRequest.contextOfUse) &&
                Objects.equals(this.defaultValue, observationVariableNewRequest.defaultValue) &&
                Objects.equals(this.documentationURL, observationVariableNewRequest.documentationURL) &&
                Objects.equals(this.externalReferences, observationVariableNewRequest.externalReferences) &&
                Objects.equals(this.growthStage, observationVariableNewRequest.growthStage) &&
                Objects.equals(this.institution, observationVariableNewRequest.institution) &&
                Objects.equals(this.language, observationVariableNewRequest.language) &&
                Objects.equals(this.method, observationVariableNewRequest.method) &&
                Objects.equals(this.observationVariableName, observationVariableNewRequest.observationVariableName) &&
                Objects.equals(this.observationVariablePUI, observationVariableNewRequest.observationVariablePUI) &&
                Objects.equals(this.ontologyReference, observationVariableNewRequest.ontologyReference) &&
                Objects.equals(this.scale, observationVariableNewRequest.scale) &&
                Objects.equals(this.scientist, observationVariableNewRequest.scientist) &&
                Objects.equals(this.status, observationVariableNewRequest.status) &&
                Objects.equals(this.submissionTimestamp, observationVariableNewRequest.submissionTimestamp) &&
                Objects.equals(this.synonyms, observationVariableNewRequest.synonyms) &&
                Objects.equals(this.trait, observationVariableNewRequest.trait);
    }

    @Override
    public int hashCode() {
        return Objects.hash(additionalInfo, commonCropName, contextOfUse, defaultValue, documentationURL, externalReferences, growthStage, institution, language, method, observationVariableName, observationVariablePUI, ontologyReference, scale, scientist, status, submissionTimestamp, synonyms, trait);
    }
