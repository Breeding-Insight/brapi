...
public class CrossPollinationEvents {
    @SerializedName("pollinationNumber")
    private String pollinationNumber = null;

    @SerializedName("pollinationSuccessful")
     ...
     **/
    @Schema(description = "The unique identifier for this pollination event")
     ...
     **/
    @Schema(description = "True if the pollination was successful")
     ...
     **/
    @Schema(description = "The timestamp when the pollination took place")
