 ...
 */
@JsonAdapter(ContentTypes.Adapter.class)
public enum ContentTypes {
    ...
    public static ContentTypes fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ContentTypes> {
        @Override
        public void write(final JsonWriter jsonWriter, final ContentTypes enumeration) throws IOException {
            jsonWriter.value(String.valueOf(enumeration.getValue()));
        }

        @Override
        public ContentTypes read(final JsonReader jsonReader) throws IOException {
            Object value = jsonReader.nextString();
            return ContentTypes.fromValue((String) (value));
        }
    }
}
