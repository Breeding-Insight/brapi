...
public class Image {
    ...
    public Image externalReferences(List<ExternalReferencesInner> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public Image addExternalReferencesItem(ExternalReferencesInner externalReferencesItem) {
     ...
     * @return imageDbId
     **/
    @Schema(example = "a55efb9c", description = "The unique identifier of an image")
