...
public class Germplasm {
    ...
    public Germplasm additionalInfo(Map<String, String> additionalInfo) {
        this.additionalInfo = additionalInfo;
        return this;
    }

    public Germplasm putAdditionalInfoItem(String key, String additionalInfoItem) {
    ...
    public Germplasm biologicalStatusOfAccessionCode(BiologicalStatusOfAccessionCodeEnum biologicalStatusOfAccessionCode) {
    ...
    public Germplasm biologicalStatusOfAccessionDescription(String biologicalStatusOfAccessionDescription) {
    ...
    public Germplasm breedingMethodName(String breedingMethodName) {
    ...
    public Germplasm collection(String collection) {
     ...
     **/
    @Schema(example = "Maize", description = "Common name for the crop   MCPD (v2.1) (CROPNAME) 10. Common name of the crop. Example: \"malting barley\", \"mas\".")
    ...
    public Germplasm externalReferences(List<CrossExternalReferences> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public Germplasm addExternalReferencesItem(CrossExternalReferences externalReferencesItem) {
     ...
     **/
    @Schema(example = "d4076594", description = "The ID which uniquely identifies a germplasm within the given database server  <br>MIAPPE V1.1 (DM-41) Biological material ID - Code used to identify the biological material in the data file. Should be unique within the Investigation. Can correspond to experimental plant ID, seed lot ID, etc. This material identification is different from a BiosampleID which corresponds to Observation Unit or Samples sections below.")
     ...
     **/
    @Schema(example = "A0000003", description = "Name of the germplasm. It can be the preferred name and does not have to be unique.  MCPD (v2.1) (ACCENAME) 11. Either a registered or other designation given to the material received, other than the donors accession number (23) or collecting number (3). First letter uppercase. Multiple names are separated by a semicolon without space.")
    ...
    public Germplasm germplasmOrigin(List<GermplasmGermplasmOrigin> germplasmOrigin) {
        this.germplasmOrigin = germplasmOrigin;
        return this;
    }

    public Germplasm addGermplasmOriginItem(GermplasmGermplasmOrigin germplasmOriginItem) {
    ...
    public Germplasm germplasmPreprocessing(String germplasmPreprocessing) {
    ...
    public Germplasm seedSourceDescription(String seedSourceDescription) {
    ...
    public Germplasm storageTypes(List<GermplasmStorageTypes> storageTypes) {
        this.storageTypes = storageTypes;
        return this;
    }

    public Germplasm addStorageTypesItem(GermplasmStorageTypes storageTypesItem) {
    ...
    public Germplasm synonyms(List<GermplasmSynonyms> synonyms) {
        this.synonyms = synonyms;
        return this;
    }

    public Germplasm addSynonymsItem(GermplasmSynonyms synonymsItem) {
    ...
    public Germplasm taxonIds(List<GermplasmTaxonIds> taxonIds) {
        this.taxonIds = taxonIds;
        return this;
    }

    public Germplasm addTaxonIdsItem(GermplasmTaxonIds taxonIdsItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accessionNumber, germplasm.accessionNumber) &&
                ...
                Objects.equals(this.biologicalStatusOfAccessionDescription, germplasm.biologicalStatusOfAccessionDescription) &&
