...
public class GermplasmMCPDSafetyDuplicateInstitutes {
     ...
     **/
    @Schema(example = "PER001", description = "MCPD (v2.1) (DUPLSITE) 25. FAO WIEWS code of the institute(s) where a safety duplicate of the accession is maintained. Follows INSTCODE standard.")
     ...
     **/
    @Schema(example = "The BrAPI Institute", description = "MCPD (v2.1) (DUPLINSTNAME) 25.1  Name of the institute where a safety duplicate of the accession is maintained.")
