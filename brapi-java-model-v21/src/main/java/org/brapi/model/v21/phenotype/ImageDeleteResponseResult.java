...
public class ImageDeleteResponseResult {
     ...
     * @return imageDbIds
     **/
    @Schema(example = "[\"6a4a59d8\",\"3ff067e0\"]", required = true, description = "The unique ids of the Image records which have been successfully deleted")
