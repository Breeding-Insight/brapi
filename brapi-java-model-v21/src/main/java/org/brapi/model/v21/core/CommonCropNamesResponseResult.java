...
public class CommonCropNamesResponseResult {
    ...
    /**
     * The array of crop names available on the server
     *
     * @return data
     **/
    @Schema(example = "[\"Tomatillo\",\"Paw Paw\"]", required = true, description = "The array of crop names available on the server")
