...
public class GermplasmPedigreeResponse {
    ...
    private PedigreeNodeDEP result = null;
    ...
    public GermplasmPedigreeResponse result(PedigreeNodeDEP result) {
        this.result = result;
        return this;
    }
     ...
     **/
    @Schema(required = true, description = "")
    public PedigreeNodeDEP getResult() {
        return result;
    }

    public void setResult(PedigreeNodeDEP result) {
        this.result = result;
    }
