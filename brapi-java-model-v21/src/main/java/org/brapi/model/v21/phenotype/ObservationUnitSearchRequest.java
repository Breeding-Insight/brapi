...
public class ObservationUnitSearchRequest {
    ...
    @SerializedName("includeObservations")
    ...
    @SerializedName("observationUnitNames")
     ...
     **/
    @Schema(example = "false", description = "Use this parameter to include a list of observations embedded in each ObservationUnit object.   CAUTION - Use this parameter at your own risk. It may return large, unpaginated lists of observation data. Only set this value to True if you are sure you need to.")
    ...
    public ObservationUnitSearchRequest observationLevelRelationships(List<ObservationUnitLevelRelationship1> observationLevelRelationships) {
        this.observationLevelRelationships = observationLevelRelationships;
        return this;
    }

    public ObservationUnitSearchRequest addObservationLevelRelationshipsItem(ObservationUnitLevelRelationship1 observationLevelRelationshipsItem) {
    ...
    public ObservationUnitSearchRequest observationLevels(List<ObservationUnitLevel1> observationLevels) {
        this.observationLevels = observationLevels;
        return this;
    }

    public ObservationUnitSearchRequest addObservationLevelsItem(ObservationUnitLevel1 observationLevelsItem) {
     ...
     **/
    @Schema(example = "[\"66bab7e3\",\"0e5e7f99\"]", description = "The unique id of an observation unit")
     ...
     **/
    @Schema(example = "[\"FieldA_PlotB\",\"SpecialPlantName\"]", description = "The human readable identifier for an Observation Unit")
    ...
    public ObservationUnitSearchRequest page(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ObservationUnitSearchRequest pageSize(Integer pageSize) {
