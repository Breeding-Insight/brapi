...
public class GermplasmDonors {
     ...
     **/
    @Schema(example = "A0000123", description = "The accession number assigned by the donor                                MCPD (v2.1) (DONORNUMB) 23. Identifier assigned to an accession by the donor. Follows ACCENUMB standard.")
    ...
    /**
     * The institute code for the donor institute &lt;br/&gt;MCPD (v2.1) (DONORCODE) 22. FAO WIEWS code of the donor institute. Follows INSTCODE standard.
     *
     * @return donorInstituteCode
     **/
    @Schema(example = "PER001", description = "The institute code for the donor institute <br/>MCPD (v2.1) (DONORCODE) 22. FAO WIEWS code of the donor institute. Follows INSTCODE standard.")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(donorAccessionNumber, donorInstituteCode);
    }
