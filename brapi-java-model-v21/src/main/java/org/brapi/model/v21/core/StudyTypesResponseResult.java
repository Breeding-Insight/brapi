...
public class StudyTypesResponseResult {
    ...
    /**
     * The list of all StudyTypes available on a given server.
     *
     * @return data
     **/
    @Schema(example = "[\"Crossing Nursery\",\"Yield study\"]", required = true, description = "The list of all StudyTypes available on a given server.")
