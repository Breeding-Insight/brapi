...
public class Sample {
    ...
    public Sample externalReferences(List<ExternalReferencesInner> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public Sample addExternalReferencesItem(ExternalReferencesInner externalReferencesItem) {
    ...
    /**
     * The ID which uniquely identifies a &#x60;Sample&#x60; &lt;br&gt; MIAPPE V1.1 (DM-76) Sample ID - Unique identifier for the sample.
     *
     * @return sampleDbId
     **/
    @Schema(example = "cd06a61d", description = "The ID which uniquely identifies a `Sample` <br> MIAPPE V1.1 (DM-76) Sample ID - Unique identifier for the sample.")
