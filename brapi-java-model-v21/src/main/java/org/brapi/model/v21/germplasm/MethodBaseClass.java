...
public class MethodBaseClass {
    ...
    public MethodBaseClass externalReferences(List<CrossExternalReferences> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public MethodBaseClass addExternalReferencesItem(CrossExternalReferences externalReferencesItem) {
    ...
    public MethodBaseClass methodPUI(String methodPUI) {
    ...
    public MethodBaseClass ontologyReference(GermplasmAttributeMethodOntologyReference ontologyReference) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(additionalInfo, bibliographicalReference, description, externalReferences, formula, methodClass, methodName, methodPUI, ontologyReference);
    }
