...
public class ObservationDeleteResponseResult {
     ...
     **/
    @Schema(example = "[\"6a4a59d8\",\"3ff067e0\"]", required = true, description = "The unique ids of the Observation records which have been successfully deleted")
