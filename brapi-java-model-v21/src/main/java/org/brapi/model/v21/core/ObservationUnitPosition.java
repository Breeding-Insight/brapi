...
public class ObservationUnitPosition {
    ...
    public ObservationUnitPosition observationLevel(ObservationUnitLevel2 observationLevel) {
    ...
    public ObservationUnitPosition observationLevelRelationships(List<ObservationUnitLevelRelationship1> observationLevelRelationships) {
        this.observationLevelRelationships = observationLevelRelationships;
        return this;
    }

    public ObservationUnitPosition addObservationLevelRelationshipsItem(ObservationUnitLevelRelationship1 observationLevelRelationshipsItem) {
