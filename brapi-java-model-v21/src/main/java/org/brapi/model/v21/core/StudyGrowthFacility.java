 ...
 */
@Schema(description = "Short description of the facility in which the study was carried out.")
...
public class StudyGrowthFacility {
     ...
     * @return PUI
     **/
    @Schema(example = "CO_715:0000162", description = "MIAPPE V1.1 (DM-27) Type of growth facility - Type of growth facility in which the study was carried out, in the form of an accession number from the Crop Ontology.")
     ...
     * @return description
     **/
    @Schema(example = "field environment condition, greenhouse", description = "MIAPPE V1.1 (DM-26) Description of growth facility - Short description of the facility in which the study was carried out.")
    ...
    public boolean equals(Object o) {
        ...
        StudyGrowthFacility studyGrowthFacility = (StudyGrowthFacility) o;
