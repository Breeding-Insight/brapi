...
public class PedigreeNodeSiblings {
     ...
     **/
    @Schema(example = "a55847ed", required = true, description = "The ID which uniquely identifies a germplasm")
     ...
     **/
    @Schema(example = "A0000592", description = "A human readable name for a germplasm")
