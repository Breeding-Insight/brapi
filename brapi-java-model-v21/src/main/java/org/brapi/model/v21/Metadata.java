...
//TODO this is generated for each module, probably only need one
/**
...
public class Metadata {
    ...
    public Metadata datafiles(List<MetadataDatafiles> datafiles) {
        this.datafiles = datafiles;
        return this;
    }

    public Metadata addDatafilesItem(MetadataDatafiles datafilesItem) {
    ...
    public Metadata status(List<MetadataStatus> status) {
        this.status = status;
        return this;
    }

    public Metadata addStatusItem(MetadataStatus statusItem) {
        if (this.status == null) {
