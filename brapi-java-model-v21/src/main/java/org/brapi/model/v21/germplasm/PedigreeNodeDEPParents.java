...
public class PedigreeNodeDEPParents {
     ...
     **/
    @Schema(example = "a55847ed", description = "The germplasm DbId of the parent of this germplasm")
     ...
     **/
    @Schema(example = "A0000592", description = "the human readable name of the parent of this germplasm")
    ...
    public PedigreeNodeDEPParents parentType(ParentTypeDEP parentType) {
