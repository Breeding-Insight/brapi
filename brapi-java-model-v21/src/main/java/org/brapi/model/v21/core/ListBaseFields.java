...
public class ListBaseFields {
    ...
    public ListBaseFields externalReferences(List<ExternalReferencesInner> externalReferences) {
        this.externalReferences = externalReferences;
        return this;
    }

    public ListBaseFields addExternalReferencesItem(ExternalReferencesInner externalReferencesItem) {
    ...
    public ListBaseFields listType(ListTypeEnum listType) {
     ...
     * @return listType
     **/
    @Schema(example = "germplasm", required = true, description = "A flag to indicate the type of objects that are referneced in a List")
