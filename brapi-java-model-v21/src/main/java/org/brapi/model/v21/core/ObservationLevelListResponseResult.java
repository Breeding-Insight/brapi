...
public class ObservationLevelListResponseResult {
     ...
     * @return data
     **/
    @Schema(example = "[{\"levelName\":\"field\",\"levelOrder\":0},{\"levelName\":\"block\",\"levelOrder\":1},{\"levelName\":\"plot\",\"levelOrder\":2},{\"levelName\":\"sub-plot\",\"levelOrder\":3},{\"levelName\":\"plant\",\"levelOrder\":4}]", required = true, description = "The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.")
