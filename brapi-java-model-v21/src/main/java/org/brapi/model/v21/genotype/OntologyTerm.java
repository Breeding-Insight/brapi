 ...
 */
@Schema(description = "An ontology term describing an attribute.")
...
public class OntologyTerm {
     ...
     * @return term
     **/
    @Schema(example = "sonic hedgehog", description = "Ontology term - the label of the ontology term the termId is pointing to.")
     ...
     * @return termURI
     **/
    @Schema(example = "MGI:MGI:98297", description = "Ontology term identifier - the CURIE for an ontology term. It differs from the standard GA4GH schema's :ref:`id ` in that it is a CURIE pointing to an information resource outside of the scope of the schema or its resource implementation.")
