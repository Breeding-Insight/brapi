...
import io.swagger.client.org.brapi.client.api.genotype.ReferencesApi;
...
public class ReferencesApiTest {
    ...
    public void referencesGetTest() throws ApiException {
        ...
        ReferencesListResponse response = api.referencesGet(referenceDbId, referenceSetDbId, accession, md5checksum, isDerived, minLength, maxLength, page, pageSize, authorization);
    ...
    public void referencesReferenceDbIdBasesGetTest() throws ApiException {
        ...
        String authorization = null;
        ReferenceBasesResponse response = api.referencesReferenceDbIdBasesGet(referenceDbId, start, end, pageToken, authorization);
    ...
    public void referencesReferenceDbIdGetTest() throws ApiException {
        String referenceDbId = null;
        String authorization = null;
        ReferenceSingleResponse response = api.referencesReferenceDbIdGet(referenceDbId, authorization);
    ...
    public void searchReferencesPostTest() throws ApiException {
        ...
        String authorization = null;
        ReferencesListResponse response = api.searchReferencesPost(body, authorization);
    ...
    public void searchReferencesSearchResultsDbIdGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        ReferencesListResponse response = api.searchReferencesSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
