...
import io.swagger.client.org.brapi.client.api.germplasm.GermplasmAttributeValuesApi;
...
public class GermplasmAttributeValuesApiTest {
    ...
    public void attributevaluesAttributeValueDbIdGetTest() throws ApiException {
        ...
        GermplasmAttributeValueSingleResponse response = api.attributevaluesAttributeValueDbIdGet(attributeValueDbId, authorization);
    ...
    public void attributevaluesAttributeValueDbIdPutTest() throws ApiException {
        ...
        String authorization = null;
        GermplasmAttributeValueSingleResponse response = api.attributevaluesAttributeValueDbIdPut(attributeValueDbId, body, authorization);
    ...
    public void attributevaluesGetTest() throws ApiException {
        ...
        String authorization = null;
        GermplasmAttributeValueListResponse response = api.attributevaluesGet(attributeValueDbId, attributeDbId, attributeName, germplasmDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
    ...
    public void attributevaluesPostTest() throws ApiException {
        ...
        String authorization = null;
        GermplasmAttributeValueListResponse response = api.attributevaluesPost(body, authorization);
    ...
    public void searchAttributevaluesPostTest() throws ApiException {
        ...
        String authorization = null;
        GermplasmAttributeValueListResponse response = api.searchAttributevaluesPost(body, authorization);
    ...
    public void searchAttributevaluesSearchResultsDbIdGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        GermplasmAttributeValueListResponse response = api.searchAttributevaluesSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
