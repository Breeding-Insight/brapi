...
import io.swagger.client.org.brapi.client.api.genotype.ReferenceSetsApi;
...
public class ReferenceSetsApiTest {
    ...
    public void referencesetsGetTest() throws ApiException {
        ...
        ReferenceSetsListResponse response = api.referencesetsGet(referenceSetDbId, accession, assemblyPUI, md5checksum, page, pageSize, authorization);
    ...
    public void referencesetsReferenceSetDbIdGetTest() throws ApiException {
        String referenceSetDbId = null;
        String authorization = null;
        ReferenceSetsSingleResponse response = api.referencesetsReferenceSetDbIdGet(referenceSetDbId, authorization);
    ...
    public void searchReferencesetsPostTest() throws ApiException {
        ...
        String authorization = null;
        ReferenceSetsListResponse response = api.searchReferencesetsPost(body, authorization);
    ...
    public void searchReferencesetsSearchResultsDbIdGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        ReferenceSetsListResponse response = api.searchReferencesetsSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
