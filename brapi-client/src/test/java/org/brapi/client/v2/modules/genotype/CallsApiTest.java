...
import io.swagger.client.org.brapi.client.api.genotype.CallsApi;
...
public class CallsApiTest {
    ...
    public void callsGetTest() throws ApiException {
        ...
        CallsListResponse response = api.callsGet(callSetDbId, variantDbId, variantSetDbId, expandHomozygotes, unknownString, sepPhased, sepUnphased, pageToken, pageSize, authorization);
    ...
    public void searchCallsPostTest() throws ApiException {
        ...
        String authorization = null;
        CallsListResponse response = api.searchCallsPost(body, authorization);
    ...
    public void searchCallsSearchResultsDbIdGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        CallsListResponse response = api.searchCallsSearchResultsDbIdGet(searchResultsDbId, pageToken, pageSize, authorization);
