...
import io.swagger.client.org.brapi.client.api.core.SeasonsApi;
...
public class SeasonsApiTest {
    ...
    public void seasonsGetTest() throws ApiException {
        ...
        SeasonListResponse response = api.seasonsGet(seasonDbId, season, year, page, pageSize, authorization);
    ...
    public void seasonsPostTest() throws ApiException {
        ...
        String authorization = null;
        SeasonListResponse response = api.seasonsPost(body, authorization);
    ...
    public void seasonsSeasonDbIdGetTest() throws ApiException {
        String seasonDbId = null;
        String authorization = null;
        SeasonSingleResponse response = api.seasonsSeasonDbIdGet(seasonDbId, authorization);
    ...
    public void seasonsSeasonDbIdPutTest() throws ApiException {
        ...
        Season body = null;
        String authorization = null;
        SeasonSingleResponse response = api.seasonsSeasonDbIdPut(seasonDbId, body, authorization);
