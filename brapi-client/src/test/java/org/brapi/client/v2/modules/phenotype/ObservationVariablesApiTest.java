...
import io.swagger.client.org.brapi.client.api.phenotype.ObservationVariablesApi;
 ...
 */
public class ObservationVariablesApiTest {

    private final ObservationVariablesApi api = new ObservationVariablesApi();
    ...
    public void searchVariablesPostTest() throws ApiException {
        ...
        ObservationVariableListResponse response = api.searchVariablesPost(body, authorization);
     ...
     */
    @Test
    public void searchVariablesSearchResultsDbIdGetTest() throws ApiException {
        String searchResultsDbId = null;
        Integer page = null;
        Integer pageSize = null;
        String authorization = null;
        ObservationVariableListResponse response = api.searchVariablesSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
     ...
     */
    @Test
    public void variablesGetTest() throws ApiException {
        String observationVariableDbId = null;
        String traitClass = null;
        ...
        Integer pageSize = null;
        String authorization = null;
        ObservationVariableListResponse response = api.variablesGet(observationVariableDbId, traitClass, studyDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
    ...
    public void variablesObservationVariableDbIdGetTest() throws ApiException {
        String observationVariableDbId = null;
        String authorization = null;
        ObservationVariableSingleResponse response = api.variablesObservationVariableDbIdGet(observationVariableDbId, authorization);
    ...
    public void variablesObservationVariableDbIdPutTest() throws ApiException {
        ...
        String authorization = null;
        ObservationVariableSingleResponse response = api.variablesObservationVariableDbIdPut(observationVariableDbId, body, authorization);
    ...
    public void variablesPostTest() throws ApiException {
        ...
        String authorization = null;
        ObservationVariableListResponse response = api.variablesPost(body, authorization);
