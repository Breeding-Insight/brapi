...
import io.swagger.client.org.brapi.client.api.germplasm.SeedLotsApi;
...
public class SeedLotsApiTest {
    ...
    public void seedlotsGetTest() throws ApiException {
        ...
        SeedLotListResponse response = api.seedlotsGet(seedLotDbId, germplasmDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
    ...
    public void seedlotsPostTest() throws ApiException {
        ...
        String authorization = null;
        SeedLotListResponse response = api.seedlotsPost(body, authorization);
    ...
    public void seedlotsSeedLotDbIdGetTest() throws ApiException {
        String seedLotDbId = null;
        String authorization = null;
        SeedLotSingleResponse response = api.seedlotsSeedLotDbIdGet(seedLotDbId, authorization);
    ...
    public void seedlotsSeedLotDbIdPutTest() throws ApiException {
        ...
        String authorization = null;
        SeedLotSingleResponse response = api.seedlotsSeedLotDbIdPut(seedLotDbId, body, authorization);
    ...
    public void seedlotsSeedLotDbIdTransactionsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        SeedLotTransactionListResponse response = api.seedlotsSeedLotDbIdTransactionsGet(seedLotDbId, transactionDbId, transactionDirection, page, pageSize, authorization);
    ...
    public void seedlotsTransactionsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        SeedLotTransactionListResponse response = api.seedlotsTransactionsGet(transactionDbId, seedLotDbId, germplasmDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
    ...
    public void seedlotsTransactionsPostTest() throws ApiException {
        ...
        String authorization = null;
        SeedLotTransactionListResponse response = api.seedlotsTransactionsPost(body, authorization);
