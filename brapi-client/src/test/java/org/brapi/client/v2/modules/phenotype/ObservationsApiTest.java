...
import io.swagger.client.org.brapi.client.api.phenotype.ObservationsApi;
...
public class ObservationsApiTest {
    ...
    public void observationsObservationDbIdGetTest() throws ApiException {
        String observationDbId = null;
        String authorization = null;
        ObservationSingleResponse response = api.observationsObservationDbIdGet(observationDbId, authorization);
    ...
    public void observationsObservationDbIdPutTest() throws ApiException {
        ...
        String authorization = null;
        ObservationSingleResponse response = api.observationsObservationDbIdPut(observationDbId, body, authorization);
    ...
    public void observationsPostTest() throws ApiException {
        ...
        String authorization = null;
        ObservationListResponse response = api.observationsPost(body, authorization);
    ...
    public void observationsPutTest() throws ApiException {
        ...
        String authorization = null;
        ObservationListResponse response = api.observationsPut(body, authorization);
    ...
    public void observationsTableGetTest() throws ApiException {
        ...
        OffsetDateTime observationTimeStampRangeEnd = null;
        String authorization = null;
        ObservationTableResponse response = api.observationsTableGet(accept, observationUnitDbId, germplasmDbId, observationVariableDbId, studyDbId, locationDbId, trialDbId, programDbId, seasonDbId, observationLevel, searchResultsDbId, observationTimeStampRangeStart, observationTimeStampRangeEnd, authorization);
    ...
    public void searchObservationsPostTest() throws ApiException {
        ...
        String authorization = null;
        ObservationListResponse response = api.searchObservationsPost(body, authorization);
    ...
    public void searchObservationsSearchResultsDbIdGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer pageSize = null;
        ObservationListResponse response = api.searchObservationsSearchResultsDbIdGet(accept, searchResultsDbId, authorization, page, pageSize);
