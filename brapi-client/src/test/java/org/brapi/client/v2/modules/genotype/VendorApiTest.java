...
import io.swagger.client.org.brapi.client.api.genotype.VendorApi;
...
public class VendorApiTest {
    ...
    public void vendorOrdersGetTest() throws ApiException {
        ...
        VendorOrderListResponse response = api.vendorOrdersGet(orderId, submissionId, page, pageSize, authorization);
    ...
    public void vendorOrdersOrderIdPlatesGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        VendorPlateListResponse response = api.vendorOrdersOrderIdPlatesGet(orderId, page, pageSize, authorization);
    ...
    public void vendorOrdersOrderIdResultsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        VendorResultFileListResponse response = api.vendorOrdersOrderIdResultsGet(orderId, page, pageSize, authorization);
    ...
    public void vendorOrdersOrderIdStatusGetTest() throws ApiException {
        String orderId = null;
        String authorization = null;
        VendorOrderStatusResponse response = api.vendorOrdersOrderIdStatusGet(orderId, authorization);
    ...
    public void vendorOrdersPostTest() throws ApiException {
        ...
        String authorization = null;
        VendorOrderSubmissionSingleResponse response = api.vendorOrdersPost(body, authorization);
    ...
    public void vendorPlatesPostTest() throws ApiException {
        ...
        String authorization = null;
        VendorPlateSubmissionIdSingleResponse response = api.vendorPlatesPost(body, authorization);
    ...
    public void vendorPlatesSubmissionIdGetTest() throws ApiException {
        String submissionId = null;
        String authorization = null;
        VendorPlateSubmissionSingleResponse response = api.vendorPlatesSubmissionIdGet(submissionId, authorization);
    ...
    public void vendorSpecificationsGetTest() throws ApiException {
        String authorization = null;
        VendorSpecificationSingleResponse response = api.vendorSpecificationsGet(authorization);
