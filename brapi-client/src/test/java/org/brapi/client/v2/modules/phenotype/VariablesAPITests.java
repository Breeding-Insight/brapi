...
public class VariablesAPITests extends BrAPIClientTest {
    ...
    @Test
    public void createMethodScaleTraitThenVariableIdPresent() {
        BrApiVariable brApiVariable = BrApiVariable.builder()
                .observationVariableDbId("test")
                .build();
        APIException exception = assertThrows(APIException.class, () -> {
            Optional<BrApiVariable> variable = variablesAPI.createMethodScaleTraitThenVariable(brApiVariable);
        });
    }

    @Test
    public void createMethodScaleTraitThenVariableNull() {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            Optional<BrApiVariable> variable = variablesAPI.createMethodScaleTraitThenVariable(null);
        });
    }

    @Test
    public void createMethodScaleTraitThenVariableMultipleIdPresent() {
        BrApiVariable brApiVariable = BrApiVariable.builder()
                .observationVariableDbId("test")
                .build();
        BrApiVariable brApiVariable1 = new BrApiVariable();
        ...
        APIException exception = assertThrows(APIException.class, () -> {
            List<BrApiVariable> variables = variablesAPI.createMethodsScalesTraitsThenVariables(brApiVariables);
        });
    }

    @Test
    public void createMethodsScalesTraitsThenVariablesMultipleEmptyList() {
    ...
    @Test
    public void createMethodsScalesTraitsThenVariablesMultipleNull() {

        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            List<BrApiVariable> variables = variablesAPI.createMethodsScalesTraitsThenVariables(null);
        });
    }

    @Test
    public void createMethodsScalesTraitsThenVariablesNullTraitMethodScale() {
    ...
    @Test
    public void createMethodsScalesTraitsThenVariablesExistingTraitMethodScaleDbId() {
    ...
    @Order(1)
    @SneakyThrows
    public void createMethodsScalesTraitsThenVariablesSuccess() {

        BrApiVariable brApiVariable = buildTestVariable();

        Optional<BrApiVariable> createdVariable = variablesAPI.createMethodScaleTraitThenVariable(brApiVariable);
    ...
    @Order(1)
    @SneakyThrows
    public void createMethodsScalesTraitsThenVariablesMultipleSuccess() {
        ...
        List<BrApiVariable> createdVariables = variablesAPI.createMethodsScalesTraitsThenVariables(variables);
