...
import io.swagger.client.org.brapi.client.api.genotype.VariantSetsApi;
...
public class VariantSetsApiTest {
    ...
    public void searchVariantsetsPostTest() throws ApiException {
        ...
        VariantSetsListResponse response = api.searchVariantsetsPost(body, authorization);
    ...
    public void searchVariantsetsSearchResultsDbIdGetTest() throws ApiException {
        ...
        String authorization = null;
        VariantSetsListResponse response = api.searchVariantsetsSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
    ...
    public void variantsetsExtractPostTest() throws ApiException {
        ...
        String authorization = null;
        VariantSetResponse response = api.variantsetsExtractPost(body, authorization);
    ...
    public void variantsetsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        VariantSetsListResponse response = api.variantsetsGet(variantSetDbId, variantDbId, callSetDbId, studyDbId, studyName, page, pageSize, authorization);
    ...
    public void variantsetsVariantSetDbIdCallsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        CallsListResponse response = api.variantsetsVariantSetDbIdCallsGet(variantSetDbId, expandHomozygotes, unknownString, sepPhased, sepUnphased, pageToken, pageSize, authorization);
    ...
    public void variantsetsVariantSetDbIdCallsetsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        CallSetsListResponse response = api.variantsetsVariantSetDbIdCallsetsGet(variantSetDbId, callSetDbId, callSetName, page, pageSize, authorization);
    ...
    public void variantsetsVariantSetDbIdGetTest() throws ApiException {
        String variantSetDbId = null;
        String authorization = null;
        VariantSetResponse response = api.variantsetsVariantSetDbIdGet(variantSetDbId, authorization);
    ...
    public void variantsetsVariantSetDbIdVariantsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        VariantsListResponse response = api.variantsetsVariantSetDbIdVariantsGet(variantSetDbId, variantDbId, pageToken, pageSize, authorization);
