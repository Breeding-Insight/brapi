...
import io.swagger.client.org.brapi.client.api.core.TrialsApi;
...
public class TrialsApiTest {
    ...
    public void searchTrialsPostTest() throws ApiException {
        ...
        TrialListResponse response = api.searchTrialsPost(body, authorization);
    ...
    public void searchTrialsSearchResultsDbIdGetTest() throws ApiException {
        ...
        String authorization = null;
        TrialListResponse response = api.searchTrialsSearchResultsDbIdGet(searchResultsDbId, page, pageSize, authorization);
    ...
    public void trialsGetTest() throws ApiException {
        ...
        Integer pageSize = null;
        String authorization = null;
        TrialListResponse response = api.trialsGet(active, commonCropName, contactDbId, programDbId, locationDbId, searchDateRangeStart, searchDateRangeEnd, studyDbId, trialDbId, trialName, trialPUI, sortBy, sortOrder, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
    ...
    public void trialsPostTest() throws ApiException {
        ...
        String authorization = null;
        TrialListResponse response = api.trialsPost(body, authorization);
    ...
    public void trialsTrialDbIdGetTest() throws ApiException {
        String trialDbId = null;
        String authorization = null;
        TrialSingleResponse response = api.trialsTrialDbIdGet(trialDbId, authorization);
    ...
    public void trialsTrialDbIdPutTest() throws ApiException {
        ...
        String authorization = null;
        TrialSingleResponse response = api.trialsTrialDbIdPut(trialDbId, body, authorization);
