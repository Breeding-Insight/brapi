...
import io.swagger.client.model.core.ServerInfoResponse;
...
public class ServerInfoApi {
     ...
     */
    public Call serverinfoGetCall(WSMIMEDataTypes dataType, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private Call serverinfoGetValidateBeforeCall(WSMIMEDataTypes dataType, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        Call call = serverinfoGetCall(dataType, authorization, progressListener, progressRequestListener);
        return call;
     ...
     */
    public ServerInfoResponse serverinfoGet(WSMIMEDataTypes dataType, String authorization) throws ApiException {
        ApiResponse<ServerInfoResponse> resp = serverinfoGetWithHttpInfo(dataType, authorization);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ServerInfoResponse> serverinfoGetWithHttpInfo(WSMIMEDataTypes dataType, String authorization) throws ApiException {
        Call call = serverinfoGetValidateBeforeCall(dataType, authorization, null, null);
     ...
     */
    public Call serverinfoGetAsync(WSMIMEDataTypes dataType, String authorization, final ApiCallback<ServerInfoResponse> callback) throws ApiException {
        ...
        Call call = serverinfoGetValidateBeforeCall(dataType, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ServerInfoResponse>(){}.getType();
