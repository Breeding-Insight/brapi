...
import io.swagger.client.model.pheno.TraitBaseClass;
import io.swagger.client.model.pheno.TraitListResponse;
import io.swagger.client.model.pheno.TraitSingleResponse;
...
public class TraitsApi {
     ...
     * @param traitDbId The unique identifier for a trait (optional)
     ...
     */
    public Call traitsGetCall(String traitDbId, String observationVariableDbId, String externalReferenceID, String externalReferenceSource, Integer page, Integer pageSize, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private Call traitsGetValidateBeforeCall(String traitDbId, String observationVariableDbId, String externalReferenceID, String externalReferenceSource, Integer page, Integer pageSize, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        Call call = traitsGetCall(traitDbId, observationVariableDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization, progressListener, progressRequestListener);
        return call;
     ...
     */
    public TraitListResponse traitsGet(String traitDbId, String observationVariableDbId, String externalReferenceID, String externalReferenceSource, Integer page, Integer pageSize, String authorization) throws ApiException {
        ApiResponse<TraitListResponse> resp = traitsGetWithHttpInfo(traitDbId, observationVariableDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TraitListResponse> traitsGetWithHttpInfo(String traitDbId, String observationVariableDbId, String externalReferenceID, String externalReferenceSource, Integer page, Integer pageSize, String authorization) throws ApiException {
        Call call = traitsGetValidateBeforeCall(traitDbId, observationVariableDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization, null, null);
     ...
     */
    public Call traitsGetAsync(String traitDbId, String observationVariableDbId, String externalReferenceID, String externalReferenceSource, Integer page, Integer pageSize, String authorization, final ApiCallback<TraitListResponse> callback) throws ApiException {
        ...
        Call call = traitsGetValidateBeforeCall(traitDbId, observationVariableDbId, externalReferenceID, externalReferenceSource, page, pageSize, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TraitListResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call traitsPostCall(List<TraitBaseClass> body, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private Call traitsPostValidateBeforeCall(List<TraitBaseClass> body, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        Call call = traitsPostCall(body, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TraitListResponse traitsPost(List<TraitBaseClass> body, String authorization) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TraitListResponse> traitsPostWithHttpInfo(List<TraitBaseClass> body, String authorization) throws ApiException {
        Call call = traitsPostValidateBeforeCall(body, authorization, null, null);
        Type localVarReturnType = new TypeToken<TraitListResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call traitsPostAsync(List<TraitBaseClass> body, String authorization, final ApiCallback<TraitListResponse> callback) throws ApiException {
        ...
        Call call = traitsPostValidateBeforeCall(body, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TraitListResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call traitsTraitDbIdGetCall(String traitDbId, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private Call traitsTraitDbIdGetValidateBeforeCall(String traitDbId, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        Call call = traitsTraitDbIdGetCall(traitDbId, authorization, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<TraitSingleResponse> traitsTraitDbIdGetWithHttpInfo(String traitDbId, String authorization) throws ApiException {
        Call call = traitsTraitDbIdGetValidateBeforeCall(traitDbId, authorization, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call traitsTraitDbIdGetAsync(String traitDbId, String authorization, final ApiCallback<TraitSingleResponse> callback) throws ApiException {
        ...
        Call call = traitsTraitDbIdGetValidateBeforeCall(traitDbId, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TraitSingleResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public Call traitsTraitDbIdPutCall(String traitDbId, TraitBaseClass body, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private Call traitsTraitDbIdPutValidateBeforeCall(String traitDbId, TraitBaseClass body, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'traitDbId' is set
        if (traitDbId == null) {
            throw new ApiException("Missing the required parameter 'traitDbId' when calling traitsTraitDbIdPut(Async)");
        }
        
        Call call = traitsTraitDbIdPutCall(traitDbId, body, authorization, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<TraitSingleResponse> traitsTraitDbIdPutWithHttpInfo(String traitDbId, TraitBaseClass body, String authorization) throws ApiException {
        Call call = traitsTraitDbIdPutValidateBeforeCall(traitDbId, body, authorization, null, null);
        Type localVarReturnType = new TypeToken<TraitSingleResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public Call traitsTraitDbIdPutAsync(String traitDbId, TraitBaseClass body, String authorization, final ApiCallback<TraitSingleResponse> callback) throws ApiException {
        ...
        Call call = traitsTraitDbIdPutValidateBeforeCall(traitDbId, body, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TraitSingleResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
