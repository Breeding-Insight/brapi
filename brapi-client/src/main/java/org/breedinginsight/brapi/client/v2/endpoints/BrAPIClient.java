...
public class BrAPIClient {
     ...
     * @param request
     * @param responseHandler User defined function to handle the <code>result</code> section of the {@link org.breedinginsight.brapi.client.v2.endpoints.model.response.BrAPIResponse}
