...
/**
 * observationDbId The unique ID of an Observation (optional)
 * observationUnitDbId The unique ID of an Observation Unit (optional)
 * observationVariableDbId The unique ID of an observation variable (optional)
 ...
 * observationTimeStampRangeStart Timestamp range start (optional)
 * observationTimeStampRangeEnd Timestamp range end (optional)
...
public class ObservationQueryParams extends PhenotypeQueryParams {
    ...
    private OffsetDateTime observationTimeStampRangeEnd;
