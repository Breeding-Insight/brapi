...
/**
 * authorization HTTP HEADER - Token used for Authorization   &lt;strong&gt; Bearer {token_string} &lt;/strong&gt; (optional)
 **/
@Getter
@Setter
@SuperBuilder
...
public abstract class BrAPISecureQueryParams extends BrAPIQueryParams {
    ...
    public void buildQueryParams(ApiClient client, List<Pair> paramList, Map<String, String> headerParams) {
        ...
        if (authorization != null)
            headerParams.put("Authorization", client.parameterToString(authorization));
    }
}
