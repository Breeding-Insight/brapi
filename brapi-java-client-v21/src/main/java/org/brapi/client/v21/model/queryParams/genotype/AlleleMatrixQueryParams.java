...
public class AlleleMatrixQueryParams extends BrAPISecureQueryParams {
    ...
    @Override
    public void buildQueryParams(ApiClient apiClient, List<Pair> paramList, Map<String, String> headerParams) {
        super.buildQueryParams(apiClient, paramList, headerParams);
        if (dimensionVariantPage != null)
            paramList.addAll(apiClient.parameterToPair("dimensionVariantPage", dimensionVariantPage));
        if (dimensionVariantPageSize != null)
            paramList.addAll(apiClient.parameterToPair("dimensionVariantPageSize", dimensionVariantPageSize));
        if (dimensionCallSetPage != null)
            paramList.addAll(apiClient.parameterToPair("dimensionCallSetPage", dimensionCallSetPage));
        if (dimensionCallSetPageSize != null)
            paramList.addAll(apiClient.parameterToPair("dimensionCallSetPageSize", dimensionCallSetPageSize));
        if (preview != null)
            paramList.addAll(apiClient.parameterToPair("preview", preview));
        if (dataMatrixNames != null)
            paramList.addAll(apiClient.parameterToPair("dataMatrixNames", dataMatrixNames));
        if (dataMatrixAbbreviations != null)
            paramList.addAll(apiClient.parameterToPair("dataMatrixAbbreviations", dataMatrixAbbreviations));
        if (positionRange != null)
            paramList.addAll(apiClient.parameterToPair("positionRange", positionRange));
        if (germplasmDbId != null)
            paramList.addAll(apiClient.parameterToPair("germplasmDbId", germplasmDbId));
        if (germplasmName != null)
            paramList.addAll(apiClient.parameterToPair("germplasmName", germplasmName));
        if (germplasmPUI != null)
            paramList.addAll(apiClient.parameterToPair("germplasmPUI", germplasmPUI));
        if (callSetDbId != null)
            paramList.addAll(apiClient.parameterToPair("callSetDbId", callSetDbId));
        if (variantDbId != null)
            paramList.addAll(apiClient.parameterToPair("variantDbId", variantDbId));
        if (variantSetDbId != null)
            paramList.addAll(apiClient.parameterToPair("variantSetDbId", variantSetDbId));
        if (expandHomozygotes != null)
            paramList.addAll(apiClient.parameterToPair("expandHomozygotes", expandHomozygotes));
        if (unknownString != null)
            paramList.addAll(apiClient.parameterToPair("unknownString", unknownString));
        if (sepPhased != null)
            paramList.addAll(apiClient.parameterToPair("sepPhased", sepPhased));
        if (sepUnphased != null)
            paramList.addAll(apiClient.parameterToPair("sepUnphased", sepUnphased));
    }
}
