...
/**
 * ontologyName The human readable identifier for an ontology definition (optional)
...
public class OntologyQueryParams extends PhenotypeQueryParams {
    ...
    public void buildQueryParams(ApiClient apiClient, List<Pair> localVarQueryParams, Map<String, String> headerParams) {
        ...
        if (ontologyName != null)
            localVarQueryParams.addAll(apiClient.parameterToPair("ontologyName", ontologyName));
