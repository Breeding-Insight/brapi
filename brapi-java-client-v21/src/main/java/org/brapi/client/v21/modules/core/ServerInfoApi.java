...
import org.brapi.model.v21.core.ContentTypes;
import org.brapi.model.v21.core.ServerInfoResponse;
...
public class ServerInfoApi {
     ...
     *
     * @param contentType             Filter the list of endpoints based on the response content type. (optional)
     * @param dataType                **Deprecated in v2.1** Please use &#x60;contentType&#x60;. Github issue number #443 &lt;br&gt;The data format supported by the call. (optional)
     ...
     */
    public com.squareup.okhttp.Call serverinfoGetCall(ContentTypes contentType, ContentTypes dataType, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call serverinfoGetValidateBeforeCall(ContentTypes contentType, ContentTypes dataType, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

        return serverinfoGetCall(contentType, dataType, authorization, progressListener, progressRequestListener);
     ...
     */
    public ServerInfoResponse serverinfoGet(ContentTypes contentType, ContentTypes dataType, String authorization) throws ApiException {
        ApiResponse<ServerInfoResponse> resp = serverinfoGetWithHttpInfo(contentType, dataType, authorization);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ServerInfoResponse> serverinfoGetWithHttpInfo(ContentTypes contentType, ContentTypes dataType, String authorization) throws ApiException {
        com.squareup.okhttp.Call call = serverinfoGetValidateBeforeCall(contentType, dataType, authorization, null, null);
        Type localVarReturnType = new TypeToken<ServerInfoResponse>() {
        }.getType();
     ...
     */
    public com.squareup.okhttp.Call serverinfoGetAsync(ContentTypes contentType, ContentTypes dataType, String authorization, final ApiCallback<ServerInfoResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = serverinfoGetValidateBeforeCall(contentType, dataType, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ServerInfoResponse>() {
        }.getType();
